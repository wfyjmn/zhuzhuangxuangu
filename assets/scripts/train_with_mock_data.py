...
class ModelTrainer:
    ...
    def load_data(self):
        ...
        train_file = os.path.join(self.data_dir, "stock_train.csv")
...
<body>
    <div class="container">
        ...
        <div class="summary-card">
            ...
            <div class="summary-grade">模型评级: A+</div>
        ...
        <div class="footer">
            ...
            <p>AI-Driven Stock Prediction System © 2024</p>
        </div>
    </div>
</body>
</html>
