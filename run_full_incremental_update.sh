#!/bin/bash
# 完整增量更新策略：补全 2023-2024 所有关键特征（换手率/PE）+ 大盘指数
...
" > full_incremental_update.log 2>&1 &

echo ""
echo "✅ 任务已后台启动"
echo "📄 日志文件: full_incremental_update.log"
echo "👀 查看命令: tail -f full_incremental_update.log"
